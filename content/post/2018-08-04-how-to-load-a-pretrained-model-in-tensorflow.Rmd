...
Need lookup table here.
See that it doesn't make sense.

[Need to do preprocessing](https://github.com/kentsommer/keras-inceptionV4/issues/5)
...
catlogits2= sess.run(logits, feed_dict={X:cat.reshape(1,299,299,3)})
np.argsort(catlogits2)
```
Now it looks right.
